...
<html><body>some html</body></html>
     ...
     time_namelookup:  0.086
        time_connect:  0.086
    time_pretransfer:  0.086
...
<html><body>some html</body></html>
     ...
     time_namelookup:  5.553
        time_connect:  5.553
    time_pretransfer:  5.553
  time_starttransfer:  5.554
          ------------------
          time_total:  5.554
...
<html><body>some html</body></html>
     ...
     time_namelookup:  0.016
        time_connect:  0.017
    time_pretransfer:  0.017
  time_starttransfer:  0.017
          ------------------
          time_total:  0.017
...
<Directory "/Users/vv/dot-local-and-dot-dev">
   Options Indexes
   AllowOverride All
   Require local
</Directory>
...
<VirtualHost *:8080>
   ServerName test.dev
   DocumentRoot "/Users/vv/dot-local-and-dot-dev/document-root"
</VirtualHost>
...
# other reason.
#
# Mutex default:/usr/local/var/run/apache2
...
#
#MIMEMagicFile /usr/local/etc/apache2/2.4/magic
...
#
# The configuration files in the /usr/local/etc/apache2/2.4/extra/ directory can be 
...
#Include /usr/local/etc/apache2/2.4/extra/httpd-multilang-errordoc.conf

# Fancy directory listings
#Include /usr/local/etc/apache2/2.4/extra/httpd-autoindex.conf

# Language settings
#Include /usr/local/etc/apache2/2.4/extra/httpd-languages.conf

# User home directories
#Include /usr/local/etc/apache2/2.4/extra/httpd-userdir.conf

# Real-time info on requests and configuration
#Include /usr/local/etc/apache2/2.4/extra/httpd-info.conf

# Virtual hosts
Include /usr/local/etc/apache2/2.4/vhosts/*conf

# Local access to the Apache HTTP Server Manual
#Include /usr/local/etc/apache2/2.4/extra/httpd-manual.conf

# Distributed authoring and versioning (WebDAV)
#Include /usr/local/etc/apache2/2.4/extra/httpd-dav.conf
